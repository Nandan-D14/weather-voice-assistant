...
class WEATHER:
    ...
    def getWeather():
        ...
        try:
                ### weather 
                api_key = 'c4e8321ee46ef4952e6cc3a9ed2478f9'
                api = '7b0d1b033dcadaf74c23a41c5588ff60'
                key = '80f4a58a086ed52d461fd91452e604ee'
                ...
                print(json_data)
                ### air pollution
                air_link= f'http://api.openweathermap.org/data/2.5/air_pollution?lat=13.9167&lon=75.5667&appid={key}'
                air = requests.get(air_link).json()
                AA = air['list'][0]
                aqi = AA['main']['aqi']
                pm2_5 = AA['components']['pm2_5']
                pm10 = AA['components']['pm10']
                if aqi <= 50 :air_quality = 'Good'
                elif aqi >=51 and aqi <= 100:  air_quality ='Moderate'
                elif aqi >=101 and aqi <= 200:  air_quality = 'Unhealthy'
                elif aqi >=201 and aqi <= 300:  air_quality = 'Very Unhealthy'
                else:air_quality ='Hazardous'
                aqiLab1.config(text= air_quality)

                if pm2_5 <= 12.0 :pm25 = 'Good'
                elif pm2_5 >=12.1 and pm2_5 <= 35.4:  pm25 = 'Moderate'
                elif pm2_5 >=35.5 and pm2_5 <= 150.4:  pm25 = 'Unhealthy'
                elif pm2_5 >=150.5 and pm2_5 <= 250.4:  pm25 = 'Very Unhealthy'
                else:pm25 = 'Hazardous'
                pm2_5Lab1.config(text= pm25)

                if pm10 <= 54 :pm_10 = 'Good'
                elif pm10 >=55 and pm10 <= 154:  pm_10 = 'Moderate'
                elif pm10 >=155 and pm10 <= 354:  pm_10 = 'Unhealthy'
                elif pm10 >=355 and pm10 <= 424:  pm_10 = 'Very Unhealthy'
                else:pm_10 = 'Hazardous'
                pm10Lab1.config(text= pm_10)
...
class Change_BG:
    def change_bg():
        ...
        aqiLab1.config(bg=cc)
        pm2_5Lab1.config(bg=cc)
        pm10Lab1.config(bg=cc)
        mainaqilab.config(bg=cc)
        aqilab.config(bg=cc)
        mainpm2_5lab.config(bg=cc)
        mainpm10lab.config(bg=cc)
        print(c[1])
    def change_bg_img():
        pass
#menu
...
Label(frame,image=firstbox,bg='red').place(x=30, y=20)       
...
d.place(x=126,y=200)
#air
mainaqilab=Label(root,text='Air Quality',font='arial 15 bold',bg='black',fg = 'yellow')
mainaqilab.place(x=750,y=155)
aqilab=Label(root,text='Aqi      :',font='arial 13 ',bg='black',fg = 'white')
aqilab.place(x=740,y=190)
mainpm2_5lab=Label(root,text='PM2.5 :',font='arial 13 ',bg='black',fg = 'white')
mainpm2_5lab.place(x=740,y=220)
mainpm10lab=Label(root,text='PM10  :',font='arial 13 ',bg='black',fg = 'white')
mainpm10lab.place(x=740,y=250)
pm2_5Lab1 = Label(root,text='2.5',font='arial 13',fg='white',bg='black')
pm10Lab1 = Label(root,text='10',font='arial 13',fg='white',bg='black')
aqiLab1 = Label(root,text='aqi',font='arial 13',fg='white',bg='black')
aqiLab1.place(x=804,y=190)
pm2_5Lab1.place(x=804,y=220)
pm10Lab1.place(x=804,y=250)
